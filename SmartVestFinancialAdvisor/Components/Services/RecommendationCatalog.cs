    ...
    public sealed class RecommendationCatalog : IRecommendationCatalog
{
    ...
    public IReadOnlyList<Recommendation> For(BuildResult result)
    {
        ...
        // Only recommend debt payoff when user actually has debt.
        ...
        // Return ALL ordered recommendations (UI can paginate/show more)
        return ordered;
    }
    ...
    )
    {
        ...
        {
            // Risk tolerance is stored on Constraints in your BuildResult.
            ...
            // ✅ FIX: subscores are on FinancialScore, not Score (Score is decimal).
